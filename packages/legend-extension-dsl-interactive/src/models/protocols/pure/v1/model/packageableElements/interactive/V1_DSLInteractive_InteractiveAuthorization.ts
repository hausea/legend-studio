...
export abstract class V1_InteractiveAuthorization implements Hashable {
  authorizationFunction!: V1_RawLambda;

  abstract get hashCode(): string;
}

export class V1_DefaultInteractiveAuthorization
  extends V1_InteractiveAuthorization
  implements Hashable
{
